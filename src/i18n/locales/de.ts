const de = {
  ...
  auth: {
    ...
    resetPasswordDesc: "Gib deine E-Mail-Adresse ein und wir senden dir einen Link zum Zurücksetzen deines Passworts.",
    sendResetLink: "Reset-Link senden",
    resetSent: "Reset-Link gesendet",
    resetSentDesc: "Überprüfe deine E-Mail für den Passwort-Reset-Link.",
  ...
  profile: {
    ...
    cancelSubscriptionConfirm: "Möchtest du deine Premium-Mitgliedschaft wirklich kündigen? Du behältst deine Vorteile bis zum Ende der Abrechnungsperiode.",
    confirmCancel: "Ja, kündigen",
    subscriptionCanceled: "Abonnement gekündigt",
    subscriptionCanceledDesc: "Deine Premium-Mitgliedschaft wurde gekündigt. Du kannst jederzeit wieder Premium werden.",
    dangerZone: "Gefahrenbereich",
    dangerZoneDesc: "Diese Aktionen sind unwiderruflich und löschen alle deine Daten permanent.",
    deleteAccount: "Konto löschen",
    deleteAccountTitle: "Konto unwiderruflich löschen",
    deleteAccountConfirm: "Möchtest du dein Konto wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden und alle deine Daten werden permanent gelöscht.",
    confirmDelete: "Ja, löschen",
    accountDeleted: "Konto gelöscht",
    accountDeletedDesc: "Dein Konto wurde erfolgreich gelöscht. Danke für die gemeinsame Zeit!",
  },
  common: { 
